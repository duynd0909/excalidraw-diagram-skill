...
Usage:
    python scripts/render_excalidraw.py <path-to-file.excalidraw> [--output path.png] [--scale 2] [--width 1920]
...
def render(
    ...
    try:
        ...
        print("Run from the skill directory: python -m pip install -r scripts/requirements.txt && python -m playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run from the skill directory: python -m playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
